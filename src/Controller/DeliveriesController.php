...
class DeliveriesController extends AppController
{
    ...
    {
        $delivery = $this->Deliveries->get($id, contain: ['Orders', 'Addresses']);
    ...
    public function add()
    {
        ...
        $addresses = $this->Deliveries->Addresses->find('list', limit: 200)->all();
        $this->set(compact('delivery', 'orders', 'addresses'));
    }
